...
# Status flags
set_property PACKAGE_PIN U19 [get_ports max_flag]  
set_property PACKAGE_PIN U14 [get_ports min_flag]  
set_property IOSTANDARD LVCMOS33 [get_ports max_flag]
set_property IOSTANDARD LVCMOS33 [get_ports min_flag]
